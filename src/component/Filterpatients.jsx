  ...
  return (
    <div>
      ...
      >
        ...
        <div className='flex gap-2 text-[13px] my-[20px] '>
          <div className='w-[50%]'>
            <TextField
              label="Заезд"
              type="date"
        ...
        <div className='font-semibold flex gap-2 mt-[50px]'>
          <button className='w-full p-[10px] rounded text-[#005456] bg-[#F5F7FA]'>Очистить все</button>
          <button className='w-full p-[10px] rounded bg-[#005456] text-white'>Применить</button>
        </div>
      </Drawer>
