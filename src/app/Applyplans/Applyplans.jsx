      ...
      <div className='flex gap-4 items-start m-[20px]'>
        ...
        <div className='w-[40%] bg-white p-[20px] rounded-2xl'>
          ...
          <div className='flex font-semibold gap-2'>
            <button className='p-[10px] cursor-pointer bg-[#1D272F1A] rounded w-full'>Отмена</button>
            <button className='p-[10px] cursor-pointer bg-[#005456] text-white rounded w-full'>Сохранить</button>
          </div>
        </div>
