  ...
  return (
    <div>
      ...
      <div className='flex justify-between items-center px-[30px] pt-[20px]'>
        <p style={{ fontFamily: "Montserrat-SemiBold", fontSize: "30px" }}>Применение настроек для всех тарифов</p>
      ...
      <div className='flex gap-4 items-start m-[20px]'>
        ...
        <div className='w-[40%] bg-white p-[20px] rounded-2xl'>
          <p style={{ fontFamily: "Montserrat-SemiBold", fontSize: "20px" }} className='font-semibold text-2xl'>Выбрать тарификацию</p>
          ...
          <div style={{ fontFamily: "Montserrat-SemiBold", fontSize: "13px" }} className='flex  gap-2'>
        ...
        <div className='bg-white w-[58%] p-[20px] rounded-2xl'>
          <div className='flex justify-between my-[20px]'>
            <p style={{ fontFamily: "Montserrat-SemiBold", fontSize: "20px" }}>Время заезда и выезда</p>
            <button>
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
          ...
          <div style={{ fontFamily: "Montserrat-SemiBold", fontSize: "13px" }} className='flex gap-2 mt-[20px]'>
            <button className='p-[10px] cursor-pointer bg-[#1D272F1A] rounded-[10px] w-full'>Отмена</button>
            <button className='p-[10px] cursor-pointer bg-[#005456] text-white rounded-[10px] w-full'>Сохранить</button>
          </div>
        </div>
