...
const Editnumber = () => {
    return (
        <div>
            ...
            <div className='flex gap-[10px] font-light text-gray-500 items-center pt-[30px] px-[20px]'>
            ...
            <div className='bg-white p-[20px] m-[20px] rounded-2xl'>
                ...
                <div className='flex gap-[30px] my-[20px] items-center'>
                    <div className='text-center border p-[20px] w-[25%] rounded-2xl border-gray-600 bg-[#ebebeb]'>
                        <p>Обложка:
                            Загрузить фото
                            (Не обязательно)</p>
                ...
                <div className='flex gap-4 mt-[30px]'>
                    ...
                    <button className='bg-[#005456] text-white p-[10px] rounded w-full'>Сохранить</button>
                </div>
