...
const Home = () => {
    return (
        <div>
            ...
            <div className='flex justify-between items-center font-light text-gray-500 p-[20px] pt-[30px]'>
            ...
            <div className='flex text-[12px] font-semibold  gap-[5px] bg-white p-[20px] mx-[20px] rounded-2xl'>
                ...
                <Link to="/residents" className='flex items-center gap-[10px] bg-[#E1EFFE] text-black p-[5px] px-[15px] rounded'>
                ...
                <button className='flex items-center gap-[10px] bg-[#FCD9BD] text-black p-[5px] px-[15px] rounded'>Отменено <span className='bg-white text-black px-[10px] rounded'>12</span></button>
            </div>
            ...
            <div className='bg-white m-[20px] p-[20px] rounded-2xl'>
                ...
                <div className='flex justify-between items-center py-[10px]'>
                    <div className='flex gap-[10px] items-center w-[40%]'>
                        <div className='flex items-center gap-[10px] px-[10px] border border-gray-400 w-[80%] rounded '>
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
                    ...
                    <div className='flex gap-[20px] items-center px-[20px] py-[10px]'>
                        ...
                        <div className='flex items-center gap-[10px] bg-[#E1EFFE] p-[10px] px-[15px] rounded text-[13px]'>
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
                ...
                <table className='w-[100%] my-[20px] rounded'>
                    <thead className='bg-[#F5F7FA]  text-gray-500  rounded-2xl text-[11px]'>
                        <tr className='text-left'>
                            <th className='p-[13px] rounded-l-2xl'>Клиент</th>
                            <th>Взрс/дети</th>
                            <th>Ночей</th>
                            <th>Номер</th>
                            <th>Тариф</th>
                    ...
                    <tbody className='text-[13px] font-medium'>
                        ...
                        <tr className='bg-[#F5F7FA]  rounded-2xl my-[30px]'>
                            ...
                            <td>25</td>
                            <td>Стандарт</td>
                            <td className='font-normal'>28.04.2025 <br /> 19:12</td>
                            <td className='font-normal'>02.05.2025 <br /> 19:12</td>
