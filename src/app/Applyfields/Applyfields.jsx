...
const Applyfields = () => {
    ...
    return (
        <div>
            ...
            <div className='flex gap-[10px] font-light text-gray-600 items-center pt-[30px] px-[20px]'>
            ...
            {rate && (
                <div className="fixed inset-0 flex items-center justify-center z-50">
                    <div
                        className="absolute inset-0 bg-black/40 bg-opacity-50 backdrop-blur-sm" ></div>
                    <div className="relative bg-white w-[40%] p-6 rounded-2xl shadow-2xl z-50 animate-fadeIn">
                        ...
                        <div className="flex gap-3 mt-6">
                            <button onClick={() => setRate(false)} className="px-4 py-2 w-full rounded-lg border border-gray-300 text-gray-700 hover:bg-gray-100 transition" >
                                Отмена
                            </button>
                            <button onClick={() => setRate(false)} className="px-4 py-2 w-full rounded-lg bg-[#005456] text-white font-medium hover:bg-[#004045] transition" >
                                Сохранить
                            </button>
                        </div>
                    </div>
            ...
            <div className='bg-white p-[20px] rounded-2xl m-[20px]'>
                ...
                <div className='flex gap-2 font-semibold my-[20px]'>
                    <button onClick={() => setRate(true)} className='p-[10px] bg-[#1D272F1A] text-[#005456] rounded w-full'>Создать новый тариф</button>
                    <button className='p-[10px] bg-[#005456] text-white rounded w-full'>Сохранить</button>
                </div>
            </div>
            ...
            {room && (
                <div className="fixed inset-0 flex items-center justify-center z-50">
                    ...
                    <div className="relative bg-white w-[40%] p-6 rounded-2xl shadow-2xl z-50 animate-fadeIn">
                        ...
                        />
                        <div className="flex gap-3 mt-6">
                            <button onClick={() => setRoom(false)} className="px-4 py-2 w-full rounded-lg border border-gray-300 text-gray-700 hover:bg-gray-100 transition" >
                                Отмена
                            </button>
                            <button onClick={() => setRoom(false)} className="px-4 py-2 w-full rounded-lg bg-[#005456] text-white font-medium hover:bg-[#004045] transition" >
                                Сохранить
                            </button>
                        </div>
                    </div>
            ...
            <div className='bg-white p-[20px] rounded-2xl m-[20px]'>
                ...
                <div className='flex gap-2 font-semibold my-[20px]'>
                    <button onClick={() => setRoom(true)} className='p-[10px] bg-[#1D272F1A] text-[#005456] rounded w-full'>Создать новый тип</button>
                    <button className='p-[10px] bg-[#005456] text-white rounded w-full'>Сохранить</button>
                </div>
            </div>
            ...
            {bed && (
                <div className="fixed inset-0 flex items-center justify-center z-50">
                    ...
                    <div className="relative bg-white w-[40%] p-6 rounded-2xl shadow-2xl z-50 animate-fadeIn">
                        ...
                        />
                        <div className="flex gap-3 mt-6">
                            <button onClick={() => setBed(false)} className="px-4 py-2 w-full rounded-lg border border-gray-300 text-gray-700 hover:bg-gray-100 transition" >
                                Отмена
                            </button>
                            <button onClick={() => setBed(false)} className="px-4 py-2 w-full rounded-lg bg-[#005456] text-white font-medium hover:bg-[#004045] transition" >
                                Сохранить
                            </button>
                        </div>
                    </div>
            ...
            <div className='bg-white p-[20px] rounded-2xl m-[20px]'>
                ...
                <div className='flex gap-2 font-semibold my-[20px]'>
                    <button onClick={() => setBed(true)} className='p-[10px] bg-[#1D272F1A] text-[#005456] rounded w-full'>Создать новый тип кровати </button>
                    <button className='p-[10px] bg-[#005456] text-white rounded w-full'>Сохранить</button>
                </div>
            </div>
            ...
            {cleaning && (
                <div className="fixed inset-0 flex items-center justify-center z-50">
                    ...
                    <div className="relative bg-white w-[40%] p-6 rounded-2xl shadow-2xl z-50 animate-fadeIn">
                        ...
                        <div className="flex gap-3 mt-6">
                            <button onClick={() => setCleaning(false)} className="px-4 py-2 w-full rounded-lg border border-gray-300 text-gray-700 hover:bg-gray-100 transition" >
                                Отмена
                            </button>
                            <button onClick={() => setCleaning(false)} className="px-4 py-2 w-full rounded-lg bg-[#005456] text-white font-medium hover:bg-[#004045] transition" >
                                Сохранить
                            </button>
                        </div>
                    </div>
            ...
            <div className='bg-white p-[20px] rounded-2xl m-[20px]'>
                ...
                <div className='flex gap-2 font-semibold my-[20px]'>
                    <button onClick={() => setCleaning(true)} className='p-[10px] bg-[#1D272F1A] text-[#005456] rounded w-full'>Создать тип уборки </button>
                    <button className='p-[10px] bg-[#005456] text-white rounded w-full'>Сохранить</button>
                </div>
            </div>
        </div>
