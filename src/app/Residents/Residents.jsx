...
import img from '../../assets/img1 (10).png'
import img1 from '../../assets/img1 (11).png'
...
const Residents = () => {
    return (
        <div className='bg-[#F5F7FA] w-full'>
            ...
            <div className='flex justify-between items-center font-light p-[20px] pt-[30px] text-gray-500'>
            ...
            <div className='bg-white m-[20px] p-[20px] rounded-2xl'>
                ...
                <div className='flex justify-between items-center py-[10px]'>
                    <div className='flex gap-[10px] items-center w-[40%]'>
                        <div className='flex items-center px-[10px] gap-[10px] border border-gray-400 w-[80%] rounded '>
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
                    ...
                    <div className='flex gap-[20px] items-center px-[20px] py-[10px]'>
                        ...
                        <div className='flex items-center gap-[10px] bg-[#005456] text-white p-[10px] px-[15px] rounded text-[13px]'>
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
                        ...
                        <div className='flex gap-[10px] bg-[#E1EFFE] p-[10px] px-[15px] rounded text-[13px]'>
                            <img src={img2} alt="" />
                ...
                <div className='p-[10px] text-[20px] font-extrabold bg-[#005456] rounded-2xl text-white'>
                    <p>Все: 125 032,06 с.</p>
                </div>
            </div>

            <div className='bg-white m-[20px] grid grid-cols-4 gap-[20px] text-[13px] p-[20px] rounded-2xl'>
                <div className='bg-[#F5F7FA] rounded-2xl p-[20px]'>
                    ...
                    <div className='mt-[20px]'>
                        <p className='flex justify-between font-bold pb-[10px]'>Шабнамова Шахло <span className='font-normal'>02.03.2025     12:00</span></p>
                        <hr />
                        <p className='flex justify-between'>Дата заезда <span>02.03.2025     12:00</span></p>
                        <p className='flex justify-between'>Дата выезда <span>02.09.2025     08:00</span></p>
                        <p className='flex justify-between'>Ночей <span>6</span></p>
                        <hr />
                        <p className='flex justify-between py-[10px]'>Номер 25 <span>Тариф</span> <span>Стандарт</span></p>
                        <hr />
                        <div className='grid grid-cols-3 gap-2 text-center mt-[10px]'>
                            <p>Сумма</p>
                            <p>Баланс</p>
                            <p>К оплате</p>
                            <p className='font-bold text-green-600'>25 000 c.</p>
                            <p className='font-bold text-green-600'>25 000 c.</p>
                            <p className='font-bold text-green-600'>25 000 c.</p>
                        </div>
                    </div>
                ...
                <div className='bg-[#F5F7FA] rounded-2xl p-[20px]'>
                    ...
                    <div className='mt-[20px]'>
                        ...
                        <div className='grid grid-cols-3 gap-2 text-center mt-[10px]'>
                            ...
                            <p className='font-bold text-green-600'>25 000 c.</p>
                            <p className='font-bold text-green-600'>25 000 c.</p>
                            <p className='font-bold text-red-600'>-23 000 c.</p>
                        </div>
                    </div>
                </div>
                <div className='bg-[#F5F7FA] rounded-2xl p-[20px]'>
