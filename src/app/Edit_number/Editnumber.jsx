...
const Editnumber = () => {
    return (
        <div>
            ...
            <div className='flex gap-[5px] font-light text-gray-500 items-center pt-[8px] px-[20px]'>
            ...
            <div className='bg-white p-[20px] m-[20px] rounded-2xl'>
                ...
                <div className='flex gap-[25px] my-[20px] items-center'>
                    <div className='text-center border p-[20px] w-[25%] rounded-2xl border-gray-600 bg-[#F5F7FA]'>
                        <p className='font-light text-[15px]'>Обложка:
                            Загрузить фото
                            (Не обязательно)</p>
                ...
                <div style={{ fontFamily: "Montserrat-SemiBold", fontSize: "13px" }} className='flex gap-4 mt-[70px]'>
                    ...
                    <button className='bg-[#005456] text-white p-[10px] rounded-[10px] w-full'>Сохранить</button>
                </div>
