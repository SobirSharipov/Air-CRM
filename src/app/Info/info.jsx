...
const Info = () => {
    ...
    return (
        <div>
            ...
            <div className='flex gap-[10px] items-center font-light p-[20px]'>
            ...
            <div className='flex justify-between mx-[20px]'>
                ...
                <div className='flex gap-[10px]'>
                    ...
                    <button className='bg-white cursor-pointer p-[5px] px-[10px] rounded'>
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
                    ...
                    <button className='bg-white cursor-pointer text-[#FF8736] p-[5px] px-[10px] rounded'>
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
                ...
                {information && (
                    <div >
                        <div className='flex gap-[30px] my-[20px] items-center'>
                            <div className='text-center border p-[20px] w-[15%] rounded-2xl border-gray-600 bg-[#dfe0e2]'>
                        ...
                        <div className='flex font-semibold justify-end gap-3 mt-[30px]'>
                            <button className='bg-[#F5F7FA] w-[30%] p-[10px] rounded text-[#005456]'>Редактировать</button>
                            <button className='bg-[#005456] w-[30%] p-[10px] rounded text-white'>Сохранить</button>
                        </div>
                    </div>
                )}
            </div>
            ...
            <div className='p-[20px] mx-[10px] my-[30px] bg-white rounded-2xl'>
                ...
                <div className='flex justify-between items-center py-[20px]'>
                    ...
                    <div className='flex font-semibold gap-3 w-[40%]'>
                        <button className='bg-[#005456] w-full p-[10px] rounded text-white'>История обращений</button>
                        <button className='bg-[#F5F7FA] w-full p-[10px] rounded text-[#005456]'>История баллов</button>
                    </div>
                </div>

                <table className='w-[100%] my-[20px]'>
                    <thead>
                        <tr className=' text-[14px] text-gray-600 bg-[#F5F7FA]'>
