...
const Layout = () => {
    ...
    return (
        <div className='flex max-w-[1370px] '>

            <header className={`${open ? 'w-[18%]' : 'w-[80px]'} h-screen transition-all duration-500 ease-in-out font-light  flex flex-col gap-[20px] pt-[30px] bg-white`}>
                ...
                <Link to="/" className='flex items-center   py-[5px] px-[30px] rounded gap-[20px] hover:bg-[#F5F7FA] '>
                    <img draggable={false} src={img5} alt="Image 1" />
                    {open && <p>Бронирование</p>}
                </Link>
                <Link to="/Calendar" className='flex items-center   py-[5px] px-[30px] rounded gap-[20px] hover:bg-[#F5F7FA] '>
                    <img draggable={false} src={img3} alt="Image 2" />
                    {open && <p>Календарь</p>}
                </Link>
                <Link to="/patients" className='flex items-center  py-[5px] px-[30px] rounded gap-[20px] hover:bg-[#F5F7FA] '>
                    <img draggable={false} src={img2} alt="Image 3" />
                    {open && <p>Пациенты</p>}
                </Link>
                <Link to="/numbers" className='flex items-center  py-[5px] px-[30px] rounded gap-[20px] hover:bg-[#F5F7FA] '>
                    <img draggable={false} src={img6} alt="Image 4" />
                    {open && <p>Номера</p>}
                </Link>
                <Link className='flex items-center  py-[5px] px-[30px] rounded gap-[20px] hover:bg-[#F5F7FA] '>
                    <img draggable={false} src={img6} alt="Image 4" />
                    {open && <p>Склад</p>}
                </Link>
                <Link className='flex items-center  py-[5px] px-[30px] rounded gap-[20px] hover:bg-[#F5F7FA] '>
                ...
                <button onClick={() => setOpen(!open)} className='flex items-center text-gray-700  p-[10px] px-[30px] rounded gap-[20px] hover:bg-[#F5F7FA] '>
            ...
            <main className={` ${open ? 'w-[82%]' : 'w-full'}  bg-[#F5F7FA] min-h-screen  overflow-y-auto h-screen`}>
                <Outlet />
            </main>
