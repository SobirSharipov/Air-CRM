    ...
    return (
        <div>
            ...
            <div className='flex justify-between items-center p-[20px]'>
                <div className='flex gap-[10px] font-light items-center py-[20px]'>
                ...
                <div className='flex gap-[10px]'>
                    <Link to={'/Listpatients'}>
                        <button className='bg-[#E6EAED] font-semibold cursor-pointer p-[5px] px-[10px] rounded'>Список пациентов</button>
                    </Link>
            ...
            <div className='flex items-start gap-[20px] mx-[10px]'>
                ...
                <div className='w-[40%]'>
                    ...
                    <div className='bg-white p-[20px] rounded-2xl'>
                        ...
                        <button className='w-full bg-[#1D272F1A] text-[#005456] font-bold p-[10px] rounded mt-[20px]'>Информация</button>
                    </div>

                    <div className='bg-white p-[20px] rounded-2xl my-[20px]'>
                        ...
                        <div className='flex gap-2 my-[20px] '>
                            <div className='w-[70%]'>
                                <TextField
                                    label="МКБ"
                                    variant="outlined"
                                    defaultValue="О03.02  Легочная недостаточ..."
                                    type="text"
                                    fullWidth
                                />
                            </div>
                        ...
                        <button onClick={() => setStory(!story)} className='w-full cursor-pointer text-[#005456] font-bold bg-[#1D272F1A] p-[10px] rounded mt-[20px] '>Вся история</button>
                    </div>
                ...
                <div className='bg-white w-[60%] rounded-2xl p-[20px]'>
                    ...
                    <div className='flex font-semibold gap-2 mt-[50px]'>
                        <Link to={'/patients'} className='w-[100%]'>
                            <button className='bg-[#1D272F1A] cursor-pointer text-[#005456] w-full p-[10px] rounded'>Отмена</button>
                        </Link>
                        <button className='bg-[#005456] cursor-pointer text-white w-full p-[10px] rounded'>Сохранить</button>
                    </div>
                </div>
